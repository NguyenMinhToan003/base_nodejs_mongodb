      ...
      <Box sx={{ display: 'flex', gap: 2, justifyContent: 'start', alignItems: 'start', width: '100%' }}>
        ...
        <Box sx={{ width: '100%' }}>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, justifyContent: 'space-between' }}>
            <Typography variant='p' color='text.primary' sx={{ fontSize: '14px', fontWeight: 'bold' }}>@{comment?.username}</Typography>
            <Typography variant='p' color='text.secondary' sx={{ fontSize: '12px' }}>{day}</Typography>
          </Box>
